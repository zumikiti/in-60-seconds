...
when working with old *drag-and-drop* tools like Powerpoint and Keynote. But
powered by Markdown. The *snap-layouts* feature allows you to create unique
slide designs that fit your specific needs.
